...
<div class="addItem">
    ...
    <form action="data-admin/additem_post.php" method="post">
        ...
        <select name="category" id="category">
            <?php foreach ($categorys as $el) { ?>
                <option value=""><?php echo $el["name"] ?? ''; ?></option>
            <?php } ?>
        </select><br>

        <label for="artcile">Артикул товара</label><br>
        <input type="text" name="artcile" id="artcile"><br>
